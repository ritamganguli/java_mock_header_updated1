...
urls_to_mock = {'https://www.lambdatest.com/resources/js/zohocrm.js': {'Server': 'ritam2.com'}, 'https://www.lambdatest.com/resources/js/zohoscript.js': {'Referrer-Policy': 'value2'}}
